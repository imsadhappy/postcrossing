...
class Account::EmailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update email" do
    patch account_email_url, params: { email: "new_email@hey.com", current_password: "Secret1*3*5*" }
    assert_redirected_to root_url
  end

  test "should not update email with wrong current password" do
    patch account_email_url, params: { email: "new_email@hey.com", current_password: "SecretWrong1*3" }
